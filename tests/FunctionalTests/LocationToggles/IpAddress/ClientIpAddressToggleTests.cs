...
{
    public class client_ip_address_toggle_should
    {
        ...
        {
            Action sut = () => new ClientIpAddressToggle(null, new StubtHttpContextAccessor(), NullLogger<ClientIpAddressToggle>.Instance);
        ...
        {
            Action sut = () => new ClientIpAddressToggle(new StubRuntimeFeatureStore((_, __) => null), null, NullLogger<ClientIpAddressToggle>.Instance);
        ...
        public async Task be_active_when_ip_address_is_in_the_ip_addresses_list()
        {
            ...
            var toggle = Build
                ...
                .AddOneParameter(nameof(ClientIpAddressToggle.IpAddresses), "143.24.20.35;143.24.20.36")
                .Build();
            ...
            var isActive = await new ClientIpAddressToggle(
                    store,
                    new StubtHttpContextAccessor(),
                    NullLogger<ClientIpAddressToggle>.Instance)
        ...
        public async Task be_inactive_when_ip_address_is_in_the_ip_addresses_list()
        {
            var toggle = Build
                .Toggle<ClientIpAddressToggle>()
                .AddOneParameter(nameof(ClientIpAddressToggle.IpAddresses), "134.24.21.35;134.24.21.36")
                .Build();
