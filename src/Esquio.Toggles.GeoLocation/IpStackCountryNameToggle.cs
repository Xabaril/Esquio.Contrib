...
{
    [DesignType(Description = "Toggle that is active depending on Country names for the request ip location using IpStack service.", FriendlyName = "IpStack Country Name")]
    ...
    public class IpStackCountryNameToggle
      : IToggle
    {
        ...
        public IpStackCountryNameToggle(IRuntimeFeatureStore featureStore, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<bool> IsActiveAsync(string featureName, string productName = null, CancellationToken cancellationToken = default)
        {
            ...
            var currentCountry = await _locationProviderService
                .GetCountryName(GetRemoteIpAddress(),accessKey);
